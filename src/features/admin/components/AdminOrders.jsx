...
import { getAllOrdersAsync, resetOrderUpdateStatus, selectOrderUpdateStatus, selectOrders, updateOrderByIdAsync, selectTotalOrders } from '../../order/OrderSlice'
...
import { Avatar, Button, Chip, FormControl, IconButton, InputLabel, MenuItem, Pagination, Select, Stack, Typography, useMediaQuery, useTheme } from '@mui/material';
...
export const AdminOrders = () => {
  ...
  useEffect(()=>{
    const pagination = { page, limit: ITEMS_PER_PAGE };
  ...
  return (
    ...
    <Stack mt={2} mb={2}>
        <Pagination count={Math.ceil(totalOrders / ITEMS_PER_PAGE)} page={page} onChange={(e, value) => setPage(value)} />
    </Stack>
    </Stack>
  )
}
