...
export const ProductList = () => {
    ...
    const handleSingleCategoryFilter = (categoryId) => {
        if (filters.category && filters.category.length === 1 && filters.category[0] === categoryId) {
                    ...
                    <Stack rowGap={2} mt={4}>
                        {categories?.map((category) => (
                            <Typography
                                ...
                                sx={{
                                    cursor: "pointer",
                                    fontWeight: filters.category?.includes(category._id) ? 600 : 300,
                                }}
                                variant='body2'
                                onClick={() => handleSingleCategoryFilter(category._id)}
                            >
                                {category.name}
                            </Typography>
                        ))}
