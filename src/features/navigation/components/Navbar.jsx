    ...
    <AppBar position="sticky" sx={{backgroundColor:"white",boxShadow:"none",color:"text.primary"}}>
        <Toolbar sx={{p:1,height:"4rem",display:"flex",justifyContent:"space-around"}}>
          ...
          <Stack flexDirection={'row'} alignItems={'center'} justifyContent={'center'} columnGap={2}>
            ...
            >

              {
                ...
                <MenuItem  onClick={handleCloseUserMenu}>
                  <Typography component={Link} color={'text.primary'} sx={{textDecoration:"none"}} to="/admin/dashboard" textAlign="center">Product Dashboard</Typography>
                </MenuItem>
                <MenuItem  onClick={handleCloseUserMenu}>
                ...
                <MenuItem  onClick={handleCloseUserMenu}>
                  <Typography component={Link} color={'text.primary'} sx={{textDecoration:"none"}} to="/admin/add-brand-category" textAlign="center">Add Brand/Category</Typography>
                </MenuItem>
                <MenuItem  onClick={handleCloseUserMenu}>
                  <Typography component={Link} color={'text.primary'} sx={{textDecoration:"none"}} to="/admin/manage-brands-categories" textAlign="center">Manage Brands/Categories</Typography>
                </MenuItem>
                </>
            ...
            {loggedInUser && userInfo?.name && <Typography variant='h6' fontWeight={300}>{is480?`${userInfo.name.toString().split(" ")[0]}`:`Hey👋, ${userInfo.name}`}</Typography>}
